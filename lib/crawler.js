...
var Crawler = function() {
  ...
  this.xmlHandler = (new this.XmlHandler).handler;
  this.httpHandler = (new this.HttpHandler).handler;
};
...
Crawler.prototype.HttpHandler = function() {
  var self = this;
  ...
  var handler = function(response) {
    ...
    response.on('data', function(data) {
      ...
      var parser = new htmlparser.Parser(self.xmlHandler);
